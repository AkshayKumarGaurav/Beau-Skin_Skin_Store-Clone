  ...
  return (
    <Slider {...settings} >
      <Box height={"180px"}  >
        ...
        <Text border="1px" borderRadius="solid" borderColor="red.700">20% off with code CELEBRATE</Text>
        <Text>$168.00</Text>
        <Button backgroundColor={"black"} color={"white"}>QUICK BUY</Button>
      </Box >
      <Box height={"180px"}  >
        ...
        <Text border="1px" borderRadius="solid" borderColor="red.700"> off with code CELEBRATE</Text>
        <Text>$178.00</Text>
        <Button backgroundColor={"black"} color={"white"}>QUICK BUY</Button>
      </Box >
      <Box height={"180px"}  >
        <Image mb={"20px"} src={"https://static.thcdn.com/images/large/webp//productimg/1600/1600/13229176-1314889399703687.jpg"}/>
        <Text>U Beauty The Multimodal Defender SPF30 50ml</Text>
        <Text border="1px" borderRadius="solid" borderColor="red.700"> off with code CELEBRATE</Text>
        <Text>$168.00</Text>
        <Button backgroundColor={"black"} color={"white"}>QUICK BUY</Button>
      </Box >
      <Box height={"180px"}  >
        ...
        <Text>U Beauty The Super Hydrator 0.5 fl oz</Text>
        <Text border="1px" borderRadius="solid" borderColor="red.700">20% off with code CELEBRATE</Text>
        <Text>$68.00</Text>
        <Button backgroundColor={"black"} color={"white"}>QUICK BUY</Button>
      </Box >
      <Box height={"180px"}  >
        ...
        <Text>U Beauty The Plasma Lip Compound 15ml (Worth $68.00)</Text>
        <Text border="1px" borderRadius="solid" borderColor="red.700"> off with code CELEBRATE</Text>
        <Text>$68.00</Text>
        <Button backgroundColor={"black"} color={"white"}>QUICK BUY</Button>
      </Box >
      <Box height={"180px"}  >
        ...
        <Text> U Beauty Resurfacing Compound 15ml / 0.5 oz</Text>
        <Text border="1px" borderRadius="solid" borderColor="red.700"> off with code CELEBRATE</Text>
        <Text>$88.00</Text>
        <Button backgroundColor={"black"} color={"white"}>QUICK BUY</Button>
      </Box >
      <Box height={"180px"}  >
        ...
        <Text>U Beauty The MANTLE Skin Conditioning Wash 150ml</Text>
        <Text border="1px" borderRadius="solid" borderColor="red.700"> off with code CELEBRATE</Text>
        <Text>$78.00</Text>
        <Button backgroundColor={"black"} color={"white"}>QUICK BUY</Button>
      </Box >
